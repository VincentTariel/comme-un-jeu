...
\end{tikzpicture}
\captionof*{figure}{Illustration du théorème de Pythagore dans le plan} 
\end{center}
\end{Th}
\begin{proof}
...
En d'autres termes, il existe  $\vec{u}\in E$ tel que  :
$$H=\left\{\vec{x}\in E:   \PS{\vec{u}}{\vec{x}}=0 \right\}.$$
Ou bien encore, il existe $\phi \in E^*$ tel que :
$$H=\ker \phi.$$ 
\end{Prop}
