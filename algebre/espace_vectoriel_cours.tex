...
\begin{itemize}
\item l'ensemble des n-uplets réels : $\vect{x}=(x_{1},x_{2},\ldots ,x_{n})$ et $E=\R^n$ et , où chaque $x_{i}$ est un réel,
...
\begin{Df}[Loi de composition interne : $\vect{x} \myop \vect{y}$  ]
...
Par identification, on obtient $\lambda_1\vect{e_1}+\dots+ \lambda_n\vect{e_n}=\vect{0}_E$ et $\beta_1\vect{f_1}+\dots+ \beta_q\vect{f_q}=\vect{0}_F$. Comme $(\vect{e_1},\dots,\vect{e_n})$ une famille libre de $E_1$ et $(\vect{f_1},\dots,\vect{f_q})$ de $E_2$ , $\lambda_1=\dots=\lambda_n=\beta_1=\dots=\beta_q=0$. 
\end{itemize}
\end{proof}
