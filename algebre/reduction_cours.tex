...
\begin{intr} La réduction d'endomorphisme a pour objectif d'exprimer des matrices et des endomorphismes sous une forme plus simple, par exemple pour faciliter les calculs. 
...
A & B \\ 0 & C
\end{pmatrix}$$
si et seulement si $F$ est stable par $u$. Dans ce cas $A=[u_F]_{\mathcal{B}'}$.
\end{Prop}
...
%\item Si $E = \oplus     _{k=1}^p F_k$ et que pour tout $k\in \ccro{1,p}$, $u_{\vert F_k}$ est une homothétie, alors $u$ est diagonalisable.
