...
%\item $E_4$, l'ensemble des solutions de l'équation différentielle $y'+a(x) y=0$, où $a\in\mathcal D$.
%\item $E_5$, l'ensemble des solutions de l'équation différentielle $y'+a(x) y=x$, où $a\in\mathcal D$.
\end{enumerate}
\finexo
...
%\begin{enumerate}
%\item $\lambda   x = 0_E$ £ssi. $\lambda   = 0_\K     $ ou $x = 0_E$;
...
%\Exercice
%
%Soit $E=\mathcal F(\mathbb R,\mathbb R)$ l'espace vectoriel des fonctions de $\mathbb R$ dans $\mathbb R$. \'Etudier l'indépendance linéaire des familles suivantes :
%\begin{enumerate}
