...
%--- Gestion des corrections ---
 ...
 \entete{\'Enoncés}
\input{exercice/denombrement_exo_anagramme}
\input{exercice/denombrement_exo_code_secret}
\input{exercice/denombrement_exo_poker}
\input{exercice/denombrement_exo_triangle}
\input{exercice/denombrement_exo_mousquetaire}
\input{exercice/denombrement_exo_democratie}
\input{exercice/denombrement_exo_google}
\input{exercice/denombrement_exo_rangement}
\input{exercice/denombrement_exo_partie}
