...
\hline \hline 
Lancer d'un dé & Un entier $k\in\{1,\dots,6\}$&dénombrable fini \\
\hline
Prélèvement de n objets en sortie d'une chaîne de production dans l'échantillon & Nombre d'objets défectueux, $k\in\{0,\dots,n\}$&dénombrable fini\\
\hline
Questionnaire à 100 questions  binaires & Suite $\omega$ de 100 réponses $\omega\in\{oui, non\}^{100}$&dénombrable fini\\
\hline
Lancer d'une pièce jusqu'à la première obtention de pile & Un entier $k \in \mathbb{N}$ : le temps d'attente du premier succès&dénombrable infini\\
\hline
...
Dans le cadre de cours, on limite l'univers à un ensemble \defi{dénombrable fini}, c'est à dire que l'on peut effectuer une énumération finie des issues de l'expérience aléatoire.    
