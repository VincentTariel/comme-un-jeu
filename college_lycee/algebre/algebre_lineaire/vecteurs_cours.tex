...
\end{Vocabulaire}
\begin{Remarque}
Une \impo{transformation} sert à \impo{modéliser} mathématiquement un mouvement.
\begin{itemize}
...
\begin{Proposition}[Diagonales du parallélogramme]
...
\begin{Definition}[Égalité entre vecteurs]
...
\begin{Methode}[Construire un vecteur] 
