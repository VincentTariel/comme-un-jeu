...
\begin{Cor}[Cardinal d'un produit cartésien]Soit $E$  de cardinal $n$.\\ Alors $card(E^p)=n^p$.
\end{Cor}
...
\end{Ex}
\begin{DfProp}[Permutation (cas n=p)]
...
\begin{DfProp}[Combinaison]\label{propcomb} 
