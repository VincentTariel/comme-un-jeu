...
\begin{Theoreme}[Convergence dominée] Soit $\fn$ une suite de fonctions continues par morceaux de $J$ dans $\K$, et $f,\phi:J\to\K$ continues par morceaux avec $\phi $ positive. On suppose que
\begin{enumerate}
...
\begin{Theoreme}[Intégration terme à terme] Soit $\Sfn$ une série de fonctions continues par morceaux de $J$ dans $\K$, et $f:J\to\K$ continue par morceaux. On suppose que
\begin{enumerate}
\item \impo{Convergence simple de $\Sfn$ vers $f$}: pour tout $t\in J$, la suite numérique $\sum_n f_n(t)$ converge vers $f(t)$;
