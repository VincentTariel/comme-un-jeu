...
\begin{Remarque}
Il faut bien distinguer la série entière $\Sanzn$ qui est une \impo{série de fonctions} ($z$ étant une "variable
muette") et la \impo{série numérique} $\Sanzn$ pour $z$ complexe fixé.
\end{Remarque}
...
\begin{Remarque} Il n'y a pas toujours convergence normale (ni uniforme) sur $\{z\in \C:\Abs{z}<\Abs{z_0}\}$.
\end{Remarque}
\begin{Lemme}
