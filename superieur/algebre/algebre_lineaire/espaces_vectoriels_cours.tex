...
\begin{Ex}[Vecteur associé à la translation dans le plan $\R^2$]%dep=vecteurs,label=vecteurs_plans 
Une \defi{translation} déplace tous les points d'un objet géométrique de la même distance, selon la même direction et dans le même sens.


 C'est-à-dire suivant un même vecteur
