\emph{?}\exo{ 0402 , tariel, 01/11/2017, 1-2, {}}[*, Nature]
...
\begin{correction}
    \begin{enumerate}
    \item on a : $$\frac{u_{n+1}}{u_n} =\frac{n+1}{3n}\rightarrow_{n\to\infty}\frac{1}{3}$$ D'après le critère de d'Alembert, la série est convergente.
...
Comme la série de Riemann $\sum \frac{1}{n^{3/2}}$ est convergente, la série $\sum \frac{n}{n^3+1}$ est convergente par règle de comparaison.
...
Comme la série de Riemann $\sum \frac{1}{n}$ est divergente, la série $\sum \frac{1}{\sqrt{n}}\ln\left(1+\frac{1}{\sqrt{n}}\right)$  est divergente par règle de comparaison.
\item $\sum \frac{\sqrt n}{n^2+\sqrt n}$ est une série à termes positifs. On a :
...
Comme la série de Riemann $\sum \frac{1}{n}$ est divergente, la série $\sum \frac{(-1)^n +n}{n^2+1}$  est divergente par règle de comparaison.
 \item   $\sum \ln\left(\frac{n^2+n+1}{n^2+n-1}\right)$ est une série à termes positifs. On a :
