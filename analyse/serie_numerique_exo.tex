...
{
{\noindent
  \textsf{Feuille d'exercices}    \hfill   \textsf{Brouillon}          % Université
}
\hrule
\hrule
\begin{center} 
...
\input{exercice/serie_numerique_exo_convergence_1}
\input{exercice/serie_numerique_exo_convergence_2}
\input{exercice/serie_numerique_exo_convergence_3}
\input{exercice/serie_numerique_exo_harmonique}
\input{exercice/serie_numerique_exo_somme}
\input{exercice/serie_numerique_exo_alternee}
\input{exercice/serie_numerique_exo_cauchy}
\input{exercice/serie_numerique_exo_scalaire}
\input{exercice/serie_numerique_exo_convergence_th}
\input{exercice/serie_numerique_exo_ln}
