...
\begin{Prop}[Indépendance du rang]
...
\begin{Prop}[Grossièrement divergente]
...
\begin{Prop}[Règle du petit o et grand O] \label{prop:comp}
...
\end{Ex}
\begin{Prop}[Règle d'équivalence]
...
La série $\sum_{n\geq n_0}f(n)$ converge si et seulement si la suite $\left( \int_{n_0}^n f(x) dx \right)_{n\in\N}$ converge.
\end{Th}
\begin{proof}
