...
\end{Df}
\begin{Ex}[Série entière]Les séries de la forme $\sum a_n x^n $  où $(a_n)_{n\in\N}$ est une suite réelle ou complexe. Par exemple, la série géométrique $\sum x^n$.
\end{Ex}
\begin{Ex}[Série trigonométrique]Les séries de la forme $\sum a_n  \cos (nx) $ et $\sum b_n  \sin (nx) $ où $(a_n)_{n\in\N}$ et $(a_n)_{n\in\N}$ suites réelles ou complexes.
\end{Ex}
...
\end{itemize}
\end{Th}
\begin{proof}[Hors programme (utilisation du critère de Cauchy)]
On a :
\begin{itemize}
...
%Je ne sais pas prouver sans les suites de Cauchy/
\end{proof}
